...
const user = {
    ...
    telephone: "062 456 8790",
    company: "IT Solutions",
    profile_picture: userProfile,
    interests: ["Biking, Swimming, Cycling, River Rafting"]
};

const element = (
    <div>
        <h1> Hello, {userGreet(user)}! </h1>
        <p>I know more about you than what you might know! </p>
        <p> You were born in the year {user.date_of_birth}. </p>
        <p> You live in {user.country}. </p>
        <p> Your email address is {user.email}. </p>
        <p> Your contact number is {user.telephone}. </p>
        <p> You own a company known as {user.company}. </p>
        <p> This is your profile picture: {user.profile_picture} </p>
        <p> Your interests are: {user.interests}. </p>
        <p> You see, I know more about you than what you can Imagine.</p>
